...
/* Derived by CG 20090806 from Harmony "enhanced" revision 785956 */
...
//            }
        ...
        private boolean inRange(List ranges) {
        ...
        public Set getAllAttributeKeys() {
            ...
            Set result = new HashSet((attrString.attributeMap.size() * 4 / 3) + 1);
            Iterator it = attrString.attributeMap
                    .entrySet().iterator();
            while (it.hasNext()) {
        ...
        private Object currentValue(List ranges) {
            Iterator it = ranges.iterator();
            while (it.hasNext()) {
                Range range = (Range)it.next();
        ...
        public Map getAttributes() {
            ...
            while (it.hasNext()) {
                ...
                if (attributesAllowed == null
                        || attributesAllowed.contains(entry.getKey())) {
                    Object value = currentValue((List)entry.getValue());
                    if (value != null) {
        ...
        private int runLimit(List ranges) {
            int result = end;
        ...
        private int runStart(List ranges) {
            int result = begin;
            Iterator it = ranges.iterator();
            while (it.hasNext()) {
                Range range = (Range)it.next();
...
//      Iterator it = attributes.iterator();
//      while (it.hasNext()) {
//        AttributedCharacterIterator.Attribute attribute = (Attribute)it.next();
//        iterator.setIndex(0);
...
//  }
  ...
  public void addAttribute(AttributedCharacterIterator.Attribute attribute,
    ...
    List ranges = (List)attributeMap.get(attribute);
    if (ranges == null) {
