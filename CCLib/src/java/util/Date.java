...
public class Date implements Serializable, Cloneable, Comparable<Date> {
    ...
    // Used by parse()
    private static int creationYear = 1970; //new Date().getYear(); // FIXME
...
//            throw new IllegalArgumentException("The string argument is null"); //$NON-NLS-1$
//        }
//
//        char sign = 0;
//        int commentLevel = 0;
...
//    }
    ...
    public String toGMTString() {
        SimpleDateFormat format1 = new SimpleDateFormat("d MMM ", Locale.ENGLISH); //$NON-NLS-1$
        SimpleDateFormat format2 = new SimpleDateFormat(
                " HH:mm:ss 'GMT'", Locale.ENGLISH); //$NON-NLS-1$
